...
export default async function AdminUsuariosPage({
  ...
  if (session.user.role !== "ADMIN") redirect("/login?from=/admin");
    ...
    <main className="px-4 py-8 md:px-8">
      ...
      <form className="mb-6 flex flex-col gap-2 sm:flex-row">
        <input
          ...
          aria-label="Buscar cuentas por nombre, correo o teléfono"
          className="min-w-0 min-h-11 flex-1 rounded-md border border-taller-iron bg-taller-night/60 px-3 py-2 text-bone placeholder:text-ash/60 focus:border-ember-bright focus:outline-none focus:ring-1 focus:ring-ember-bright/40 font-body text-base"
        />
        <button
          type="submit"
              ...
              >
                <div className="flex items-start justify-between gap-2">
                  <div className="min-w-0">
                    <p className="font-subhead text-bone flex flex-wrap items-center gap-1.5 break-words">
                      {u.debeCambiarContrasena && (
                    ...
                    <p className="text-ash text-base flex items-center gap-1 mt-1 break-all">
