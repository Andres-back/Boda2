    ...
    <main className="px-3 py-4 md:px-8 md:py-8 max-w-xl mx-auto">
      <div className="mb-4 md:mb-6 text-center">
        ...
        <p className="text-bone text-base md:text-lg mt-1.5 md:mt-2">
          Valida el pase QR del invitado y registra su ingreso o reingreso a la boda.
        </p>
      </div>
      ...
      <Card className="mt-4 md:mt-6 hidden sm:block">
        ...
        <CardContent>
          <p className="text-bone text-base">
            ...
            <span className="font-mono text-ember-bright">AA-A7K2P9M3</span>{" "}
            o <span className="font-mono text-ember-bright">AAA7K2P9M3</span>.
          </p>
        </CardContent>
      </Card>
    </main>
