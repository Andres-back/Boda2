...
import { ACCESS_CODE_FORMAT, ACCESS_CODE_REGEX } from "@/lib/access-code";
...
const formSchema = z.object({
  codigo: z
    ...
    .regex(ACCESS_CODE_REGEX, `Formato: ${ACCESS_CODE_FORMAT}`),
});
      ...
      >
        ...
        <div className="flex gap-2">
          <input
            ...
            autoCorrect="off"
            spellCheck={false}
            placeholder={ACCESS_CODE_FORMAT}
  ...
  return (
    ...
    >
      ...
      <div className="border-t border-taller-iron/50 pt-2.5 md:pt-3 mt-2.5 md:mt-3 space-y-2.5 md:space-y-3">
        ...
        <div className="grid grid-cols-1 gap-2 rounded-md border border-white/10 bg-taller-night/45 p-3 text-sm sm:grid-cols-2">
          ...
          {invitado.ultimoReingresoEn && (
            <div className="sm:col-span-2 rounded-md border border-ember-bright/20 bg-ember-bright/5 px-3 py-2 text-ember-bright">
