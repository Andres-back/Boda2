...
export function EditarConfiguracionForm({
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
              <label htmlFor="fecha" className="block text-sm text-ash uppercase tracking-widest font-subhead mb-1">
                Fecha y hora de la ceremonia (Colombia)
              </label>
              <Input
                id="fecha"
                type="datetime-local"
      ...
      <div>
        <label htmlFor="horaRecepcion" className="block text-sm text-ash uppercase tracking-widest font-subhead mb-1">Hora de la recepción (Colombia)</label>
        <Input id="horaRecepcion" type="time" {...register("horaRecepcion")} className="h-12 text-base" />
        {errors.horaRecepcion && <p className="text-signal-rust text-sm mt-1">{errors.horaRecepcion.message}</p>}
        <p className="mt-2 text-sm text-ash">La ceremonia y la recepción comparten el lugar indicado arriba.</p>
      </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div>
              <label htmlFor="organizadorWhatsapp" className="block text-sm text-ash uppercase tracking-widest font-subhead mb-1">
                WhatsApp para fotos y consultas
              </label>
              <Input
