...
-- Convertir la columna antes de eliminar el enum anterior.
-- Los estados históricos pagados/código emitido pasan a PARCIAL y se
-- completan después desde los invitados individuales.
...
ALTER TABLE "reservas"
  ...
  USING (
    CASE "estado"::TEXT
      ...
      WHEN 'PAGADO' THEN 'PARCIAL'
      WHEN 'CODIGO_EMITIDO' THEN 'PARCIAL'
      ELSE 'PAGO_PENDIENTE'
    END
  )::"EstadoReserva";
